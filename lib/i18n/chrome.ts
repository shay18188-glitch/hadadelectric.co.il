...
const ICONS = {
  ...
  bundles: "M4 8.5 12 4l8 4.5-8 4.5-8-4.5Zm0 5L12 18l8-4.5M4 18l8 4 8-4",
  recommended: "m12 3 1.8 5.5H20l-5 3.7 1.9 5.8-4.9-3.5L7.1 18 9 12.2 4 8.5h6.2L12 3Z",
...
export const CHROME: Record<Locale, ChromeDict> = {
  he: {
    nav: [
      ...
      { href: "/bundles", label: "חבילות", icon: ICONS.bundles },
      { href: "/recommended", label: "מומלצים", icon: ICONS.recommended },
    ...
    footer: {
      tagline:
        "חדד יובל אלקטריק היא חנות מוצרי חשמל בנהריה, עם קטלוג רחב של מקררים, מכונות כביסה, מייבשים, מדיחי כלים, תנורים, כיריים, טלוויזיות, מזגנים ושואבים ממותגים מובילים. אנו משרתים לקוחות פרטיים בכל צפון הארץ — מחיפה והקריות, דרך עכו, נהריה, כרמיאל ומעלות, ועד שלומי והגבול הצפוני — ומציעים ייעוץ אישי, בדיקת זמינות, משלוח עד הבית ובמוצרים המתאימים גם תיאום התקנה. באתר אפשר להתרשם מהמבחר, להשוות דגמים ולפנות ישירות לצוות החנות לקבלת הצעת מחיר.",
      catalogTitle: "מרכזי קנייה ותוכן",
      catalogLinks: [
        { href: "/products", label: "כל המוצרים" },
        { href: "/categories", label: "קטגוריות" },
        { href: "/brands", label: "מותגים" },
        { href: "/guides", label: "מדריכים" },
        { href: "/bundles", label: "חבילות מומלצות" },
        { href: "/recommended", label: "מומלצים והשוואות" },
