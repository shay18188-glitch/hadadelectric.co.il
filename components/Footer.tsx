      ...
      <div className="container-page grid gap-10 py-12 md:grid-cols-5">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-graphite-soft/80">
            חנות מוצרי חשמל בנהריה, משרתת לקוחות פרטיים בנהריה והצפון — מקו חיפה ועד הגבול עם לבנון. האתר מציג קטלוג
            מוצרים וזמינות כללית בלבד. אין באתר מחירים או סליקה. זמינות המלאי כפופה לאישור החנות.
          </p>
